...
public class TexCommandContainer {
    ...
    public static final TexCommandEntry[] builtIn = {
            ...
            //new TexCommandEntry("fffamily", "{\\fffamily argument}\n\nFormats the argument to teletype font.", 0),
            ...
            new TexCommandEntry("itshape", "\\itshape{text}\n\nOutputs the text in italic.", 1),
            ...
            new TexCommandEntry("rm", "{\\rm argument}\n\nFormats the argument to a plain roman font.", 0),
            new TexCommandEntry("rmfamily", "{\\rmfamily argument}\n\nFormats the argument to a plain roman font.", 0),
            ...
            new TexCommandEntry("tt", "{\\tt argument}\n\nFormats the argument to teletype font.", 0),
